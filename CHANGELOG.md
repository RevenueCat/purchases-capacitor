...
## RevenueCat SDK
### 🐞 Bugfixes
* Bump PHC to 19.3.0 and fix errors not matching PurchasesError (#579) via Cesar de la Vega (@vegaro)
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 19.3.1 (#926) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 19.2.0 (#916) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `fc64a1a` to `9f7a03e` (#925) via dependabot[bot] (@dependabot[bot])
* Auto-merge PHC bump PRs (#924) via Álvaro Brey (@AlvaroBrey)
* test(ios): Add an iOS test target pinning the reject payload shape (#919) via Álvaro Brey (@AlvaroBrey)
* Bump fastlane from 2.240.0 to 2.240.1 (#922) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `6db1da0` to `fc64a1a` (#923) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.239.0 to 2.240.0 (#917) via dependabot[bot] (@dependabot[bot])
* ci: approve the release hold automatically when the release PR is approved (#912) via Álvaro Brey (@AlvaroBrey)

## 13.6.0
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 19.0.0 (#908) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.38.0 (#907) via RevenueCat Git Bot (@RCGitBot)

## RevenueCatUI SDK
### ✨ New Features
* feat(paywalls): Add onInteraction to PaywallListener (#909) via Álvaro Brey (@AlvaroBrey)

### 🔄 Other Changes
* docs: Link the paywall interaction event reference (#910) via Álvaro Brey (@AlvaroBrey)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.32.1 (#887) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Update sdks-common-config orb to v4.6.1 (#888) via Antonio Pallares (@ajpallares)

## 13.4.1
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.31.0 (#882) via RevenueCat Git Bot (@RCGitBot)
...
* [RENOVATE] Update dependency revenuecat to v4.6.0 (#876) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.30.1 (#875) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.30.0 (#874) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `7fbbe66` to `7dd9ab9` (#883) via dependabot[bot] (@dependabot[bot])
* [EXTERNAL] Remove deprecated package attribute from purchases-capacitor-ui AndroidManifest (#879) via @HarelM (#880) via Álvaro Brey (@AlvaroBrey)
* Bump fastlane from 2.237.0 to 2.238.0 (#877) via dependabot[bot] (@dependabot[bot])
* Wire mise into CI for Node, Ruby, and JDK (#871) via Álvaro Brey (@AlvaroBrey)
* Bump fastlane-plugin-revenuecat_internal from `b4e1e7f` to `7fbbe66` (#873) via dependabot[bot] (@dependabot[bot])

## 13.4.0
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.29.0 (#864) via RevenueCat Git Bot (@RCGitBot)

## RevenueCatUI SDK
### ✨ New Features
* Add onWebCheckoutOpened and onUrlOpened to the paywall listener (#856) via Álvaro Brey (@AlvaroBrey)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `dd577ee` to `b4e1e7f` (#870) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `3421c88` to `dd577ee` (#868) via dependabot[bot] (@dependabot[bot])
* Bump danger from 9.6.0 to 9.6.1 (#867) via dependabot[bot] (@dependabot[bot])
...
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.28.0 (#863) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.27.0 (#862) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.14.1 (#808) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Bump fastlane from 2.236.0 to 2.236.1 (#806) via dependabot[bot] (@dependabot[bot])

## 13.1.6
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.11.0 (#802) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane from 2.235.0 to 2.236.0 (#803) via dependabot[bot] (@dependabot[bot])

## 13.1.5
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.10.0 (#800) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `af7bb5c` to `ce6a7ef` (#798) via dependabot[bot] (@dependabot[bot])

## 13.1.4
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.9.1 (#796) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.8.0 (#792) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.7.1 (#791) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane from 2.234.0 to 2.235.0 (#793) via dependabot[bot] (@dependabot[bot])

## 13.1.2
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.7.0 (#789) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.6.0 (#785) via RevenueCat Git Bot (@RCGitBot)
...
* [RENOVATE] Update dependency gradle to v8.14.5 (#786) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.5.0 (#784) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### ✨ New Features
* Unified StoreReplacementMode API (#779) via Will Taylor (@fire-at-will)
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.4.0 (#782) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.3.0 (#778) via RevenueCat Git Bot (@RCGitBot)
* [RENOVATE] Update build-dependencies (#776) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.2.0 (#774) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* Updates purchases-hybrid-common to 17.54.0 (#745) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.53.0 (#737) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.28.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.28.1)
  * [Android 9.28.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.28.0)
  * [Android 9.27.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.27.0)
  * [iOS 5.67.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.67.0)
...
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.52.0 (#732) via RevenueCat Git Bot (@RCGitBot)
...
* Updates purchases-hybrid-common to 17.51.1 (#729) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.26.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.26.1)
  * [Android 9.26.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.26.0)
  * [iOS 5.65.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.65.0)
  * [iOS 5.64.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.64.0)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.49.0 (#724) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.26.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.26.1)
  * [Android 9.26.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.26.0)
  * [iOS 5.65.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.65.0)
  * [iOS 5.64.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.64.0)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.48.0 (#722) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.26.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.26.1)
  * [Android 9.26.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.26.0)
  * [iOS 5.65.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.65.0)
  * [iOS 5.64.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.64.0)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.47.0 (#718) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.46.1 (#715) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.25.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.25.0)
  * [Android 9.24.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.24.0)
  * [iOS 5.63.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.63.0)
  * [iOS 5.62.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.62.0)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.45.0 (#709) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.44.0 (#708) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.23.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.1)
  * [Android 9.23.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.0)
  * [iOS 5.61.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.61.0)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.42.0 (#704) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Update orb to use new trust-github job (#703) via Cesar de la Vega (@vegaro)
* Bump fastlane from 2.232.1 to 2.232.2 (#702) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `ea6276c` to `8cd957f` (#698) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### ✨ New Features
* [SDK-4264] Add PaywallListener and PurchaseLogic to purchases-capacitor-ui (#688) via Toni Rico (@tonidero)
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.41.1 (#692) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.41.0 (#689) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.22.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.22.1)
  * [iOS 5.59.2](https://github.com/RevenueCat/purchases-ios/releases/tag/5.59.2)
  * [iOS 5.59.1](https://github.com/RevenueCat/purchases-ios/releases/tag/5.59.1)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `afc9219` to `ea6276c` (#691) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.31.0 (#667) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Add LeakCanary to Android purchaseTester example app (#665) via Rick (@rickvdl)
...
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.30.0 (#661) via RevenueCat Git Bot (@RCGitBot)
...
* [RENOVATE] Update dependency gradle to v8.14.4 (#658) via RevenueCat Git Bot (@RCGitBot)

## 12.0.5
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.28.1 (#651) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.28.0 (#649) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.19.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.19.1)
  * [iOS 5.55.2](https://github.com/RevenueCat/purchases-ios/releases/tag/5.55.2)
  * [iOS 5.55.1](https://github.com/RevenueCat/purchases-ios/releases/tag/5.55.1)
  * [iOS 5.55.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.55.0)
...
### 🔄 Other Changes
* Bump fastlane from 2.231.0 to 2.231.1 (#652) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.230.0 to 2.231.0 (#650) via dependabot[bot] (@dependabot[bot])

## 12.0.4
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.27.1 (#647) via RevenueCat Git Bot (@RCGitBot)
  * [iOS 5.54.1](https://github.com/RevenueCat/purchases-ios/releases/tag/5.54.1)

## 12.0.3
## RevenueCat SDK
### 🐞 Bugfixes
* Fix purchases-hybrid-common version in Package.swift (#645) via Cesar de la Vega (@vegaro)
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.27.0 (#643) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.26.1 (#641) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.21.0 (#613) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.20.0 (#611) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.15.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.15.0)
  * [Android 9.14.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.1)
  * [iOS 5.49.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.49.0)

### 🔄 Other Changes
* Bump fastlane from 2.229.0 to 2.229.1 (#612) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.228.0 to 2.229.0 (#609) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `083ced9` to `efca663` (#610) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.19.1 (#606) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.14.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.1)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.19.0 (#605) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.14.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.1)
  * [Android 9.14.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.0)
  * [iOS 5.48.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.48.0)
  * [iOS 5.47.1](https://github.com/RevenueCat/purchases-ios/releases/tag/5.47.1)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.16.1 (#592) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.13.0 (#581) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.12.0 (#577) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* [CI] Use next patch version for dry_run publish step (#578) via Antonio Pallares (@ajpallares)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.11.0 (#574) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.9.1 (#562) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.6.0 (#533) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Update bundle deps (#535) via Cesar de la Vega (@vegaro)
...
### ✨ New Features
* Support `automaticDeviceIdentifierCollectionEnabled` when configuring the SDK (#526) via Toni Rico (@tonidero)
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.5.0 (#527) via RevenueCat Git Bot (@RCGitBot)
...
### Paywallv2
#### 🐞 Bugfixes
* Add `presentedOfferingContext` data when presenting paywall (#524) via Toni Rico (@tonidero)

### 🔄 Other Changes
* Add warning with 11.x issues to all versions since 11.0.0 in CHANGELOG (#522) via Toni Rico (@tonidero)
...
* [RENOVATE] Update dependency com.android.tools.build:gradle to v8.12.0 (#506) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 13.35.0 (#461) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 13.33.0 (#456) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 13.32.0 (#445) via RevenueCat Git Bot (@RCGitBot)
