...
public class PurchasesPlugin: CAPPlugin, PurchasesDelegate, CAPBridgedPlugin {
    ...
    public let pluginMethods: [CAPPluginMethod] = [
        ...
        CAPPluginMethod(name: "invalidateVirtualCurrenciesCache", returnType: CAPPluginReturnPromise),
        ...
        CAPPluginMethod(name: "setFinishTransactions", returnType: CAPPluginReturnPromise),
        ...
        CAPPluginMethod(name: "syncAmazonPurchase", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "enableAdServicesAttributionTokenCollection", returnType: CAPPluginReturnPromise),
        ...
        CAPPluginMethod(name: "setSingularDeviceID", returnType: CAPPluginReturnPromise),
        ...
        CAPPluginMethod(name: "overridePreferredUILocale", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "trackCustomPaywallImpression", returnType: CAPPluginReturnPromise),
    ]
    private let platformFlavor = "capacitor"
    private let platformVersion = "13.6.1"
