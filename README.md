...
* [`setSingularDeviceID(...)`](#setsingulardeviceid)
...
```typescript
setSingularDeviceID(options: { singularDeviceID: string | null; }) => Promise<void>
```
...
| Param         | Type                                               | Description                                                                                                       |
| ------------- | -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| **`options`** | <code>{ singularDeviceID: string \| null; }</code> | Singular device ID to use in the Singular integration. Empty String or null will delete the subscriber attribute. |
