...
public class PurchasesPlugin: CAPPlugin, CAPBridgedPlugin, PurchasesDelegate {
    ...
    public let pluginMethods: [CAPPluginMethod] = [
        ...
        CAPPluginMethod(
            name: "invalidateVirtualCurrenciesCache", returnType: CAPPluginReturnPromise),
        ...
        CAPPluginMethod(name: "setMockWebResults", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setSimulatesAskToBuyInSandbox", returnType: CAPPluginReturnPromise),
        ...
        CAPPluginMethod(
            name: "syncAttributesAndOfferingsIfNeeded", returnType: CAPPluginReturnPromise),
        ...
        CAPPluginMethod(name: "syncObserverModeAmazonPurchase", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(
            name: "enableAdServicesAttributionTokenCollection", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "isAnonymous", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(
            name: "checkTrialOrIntroductoryPriceEligibility", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "getPromotionalOffer", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(
            name: "getEligibleWinBackOffersForProduct", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(
            name: "getEligibleWinBackOffersForPackage", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(
            name: "purchaseProductWithWinBackOffer", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(
            name: "purchasePackageWithWinBackOffer", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "invalidateCustomerInfoCache", returnType: CAPPluginReturnPromise),
        ...
        CAPPluginMethod(name: "setProxyURL", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "collectDeviceIdentifiers", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setAdjustID", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setAppsflyerID", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setFBAnonymousID", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setMparticleID", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setCleverTapID", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setMixpanelDistinctID", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setFirebaseAppInstanceID", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setOnesignalID", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setOnesignalUserID", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setAirshipChannelID", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setMediaSource", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setCampaign", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setAdGroup", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setAd", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setKeyword", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setCreative", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "canMakePayments", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(
            name: "beginRefundRequestForActiveEntitlement", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(
            name: "beginRefundRequestForEntitlement", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "beginRefundRequestForProduct", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "showInAppMessages", returnType: CAPPluginReturnPromise),
        ...
        CAPPluginMethod(
            name: "removeCustomerInfoUpdateListener", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(
            name: "addShouldPurchasePromoProductListener", returnType: CAPPluginReturnCallback),
        CAPPluginMethod(
            name: "removeShouldPurchasePromoProductListener", returnType: CAPPluginReturnPromise),
    ]
    ...
    @objc func configure(_ call: CAPPluginCall) {
        ...
        if purchasesAreCompletedByString == PurchasesAreCompletedBy.revenueCat.name {
            ...
            if let purchasesAreCompletedByObject = call.getObject("purchasesAreCompletedBy") {
                ...
                if let newStoreKitVersion = purchasesAreCompletedByObject["storeKitVersion"]
                    as? String,
        ...
        let shouldShowInAppMessagesAutomatically =
            call.getBool("shouldShowInAppMessagesAutomatically") ?? true
        ...
        let automaticDeviceIdentifierCollectionEnabled =
            call.getBool("automaticDeviceIdentifierCollectionEnabled") ?? true
    ...
    @objc func redeemWebPurchase(_ call: CAPPluginCall) {
        guard let webPurchaseRedemption = call.getOrRejectObject("webPurchaseRedemption") else {
            return
        }
        ...
        CommonFunctionality.redeemWebPurchase(
            urlString: redemptionLink,
    ...
    @objc func setSimulatesAskToBuyInSandbox(_ call: CAPPluginCall) {
        guard let simulatesAskToBuyInSandbox = call.getOrRejectBool("simulatesAskToBuyInSandbox")
        else { return }
    ...
    @objc func getCurrentOfferingForPlacement(_ call: CAPPluginCall) {
        guard self.rejectIfPurchasesNotConfigured(call) else { return }
        guard let placementIdentifier = call.getOrRejectString("placementIdentifier") else {
            return
        }
        CommonFunctionality.getCurrentOffering(
            forPlacement: placementIdentifier, completion: self.getCompletionBlockHandler(call))
    }

    @objc func syncAttributesAndOfferingsIfNeeded(_ call: CAPPluginCall) {
        guard self.rejectIfPurchasesNotConfigured(call) else { return }
        CommonFunctionality.syncAttributesAndOfferingsIfNeeded(
            completion: self.getCompletionBlockHandler(call))
    }
    ...
    @objc func purchasePackage(_ call: CAPPluginCall) {
        ...
        guard let presentedOfferingContext = package["presentedOfferingContext"] as? [String: Any]
        else {
    ...
    @objc func restorePurchases(_ call: CAPPluginCall) {
        guard self.rejectIfPurchasesNotConfigured(call) else { return }
        CommonFunctionality.restorePurchases(
            completion:
    ...
    @objc func recordPurchase(_ call: CAPPluginCall) {
        ...
        if #available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, *) {
            CommonFunctionality.recordPurchase(
                productID: productID,
                completion: self.getCompletionBlockHandler(
                    call,
            ...
            NSLog(
                "[Purchases] Warning: tried to record purchase, but it's only available on iOS 15.0+"
            )
            call.unavailable()
        }
    }
    ...
    @objc func logIn(_ call: CAPPluginCall) {
        ...
        CommonFunctionality.logIn(
            appUserID: appUserID, completion: self.getCompletionBlockHandler(call))
    }

    @objc func logOut(_ call: CAPPluginCall) {
        guard self.rejectIfPurchasesNotConfigured(call) else { return }
        CommonFunctionality.logOut(
            completion: self.getCompletionBlockHandler(call, wrapperKey: self.customerInfoKey))
    }
    ...
    @objc func getCustomerInfo(_ call: CAPPluginCall) {
        guard self.rejectIfPurchasesNotConfigured(call) else { return }
        CommonFunctionality.customerInfo(
            completion: self.getCompletionBlockHandler(
                call,
    ...
    @objc func checkTrialOrIntroductoryPriceEligibility(_ call: CAPPluginCall) {
        ...
        CommonFunctionality.checkTrialOrIntroductoryPriceEligibility(for: productIds) {
            eligibilityResults in
    ...
    @objc func getPromotionalOffer(_ call: CAPPluginCall) {
        ...
        CommonFunctionality.promotionalOffer(
            for: productId,
    ...
    @objc func getEligibleWinBackOffersForProduct(_ call: CAPPluginCall) {
        ...
        guard let product = call.getOrRejectObject("product"),
            let productID = product["identifier"] as? String
        else {
    ...
    @objc func purchasePackageWithWinBackOffer(_ call: CAPPluginCall) {
        ...
        guard let presentedOfferingContext = aPackage["presentedOfferingContext"] as? [String: Any]
        else {
            call.reject("aPackage parameter did not have presentedOfferingContext key")
            return
        }
    ...
    @objc func beginRefundRequestForActiveEntitlement(_ call: CAPPluginCall) {
        ...
        if #available(iOS 15.0, *) {
            CommonFunctionality.beginRefundRequestForActiveEntitlement(
                completion:
    ...
    @objc func showInAppMessages(_ call: CAPPluginCall) {
        ...
        let intMessageTypes = call.getArray("messageTypes") as? [Int]
            ...
            if #available(iOS 16.0, *) {
                ...
                NSLog(
                    "[Purchases] Warning: tried to show in app messages, but it's only available on iOS 16.0+"
                )
                call.resolve()
            }
        #else
            NSLog(
                "[Purchases] Warning: tried to show in app messages, but it's only available on iOS or macCatalyst"
            )
            call.resolve()
        #endif
    }
    ...
    public func purchases(_ purchases: Purchases, receivedUpdated customerInfo: CustomerInfo) {
        self.customerInfoUpdateListeners.forEach { [weak self] callbackId in
            self?.bridge?.savedCall(withID: callbackId)?.resolve(
                CommonFunctionality.encode(customerInfo: customerInfo))
        }
